...
<template>
  <svg :width="width" :height="220">
    ...
    <line :x1="j * 4 + 2 + (padding_left ? 2 : 0)" y1="10" :x2="j * 4 + 2 + (padding_left ? 2 : 0)" :y2="actual_height"
      stroke-width="4" :stroke="parseInt(code[j]) ? `black` : `white`" v-for="j in Array(7).keys()" />
